...
public class TagsRecord extends UpdatableRecordImpl<TagsRecord> implements Record3<Integer, Integer, String> {
	...
	private static final long serialVersionUID = 1432794791;

	/**
	 * Setter for <code>public.tags.iid</code>.
	 */
	...
	/**
	 * Getter for <code>public.tags.iid</code>.
	 */
	 ...
	 */
	public TagsRecord(Integer iid, Integer id, String tag) {
		super(Tags.TAGS);
